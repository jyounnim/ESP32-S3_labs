/*
 * 03_SENSOR_ANOMALY_LAB - Step 4: On-device Autoencoder inference
 *
...
extern "C" void app_main(void)
{
    ...
    oled_status_init();
    oled_status_show("LAB03 Step4", "Starting...", "");
    ...
    while (1) {
        ...
        if (mse > ANOMALY_THRESHOLD) {
            ...
            oled_status_show("LAB03 Step4", "** ANOMALY **", mse_line);
        } else {
            printf("normal, mse=%.4f\n", mse);
            oled_status_show("LAB03 Step4", "normal", mse_line);
        }
    }
}
