/*
 * 03_SENSOR_ANOMALY_LAB - Step 1: Normal-state data collection
 *
...
void app_main(void)
{
    ...
    oled_status_init();
    oled_status_show("LAB03 Step1", "Collecting...", "windows: 0");
    ...
    while (1) {
        ...
        oled_status_show("LAB03 Step1", "Collecting...", line2);
    }
}
